...
<section id="donate" class="module">
  <h2>Donate</h2>
  <p>Please consider making a donation towards our running costs.  Cheers and UTP!</p>
  <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
      <input type="hidden" name="cmd" value="_s-xclick">
      <input type="hidden" name="hosted_button_id" value="D3Z4D6XWKV9Q4">
